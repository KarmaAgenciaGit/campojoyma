-- Agrega filtro triestado de estado en Ceox a la paginacion agrupada de pedidos.
...
is 'Devuelve una pagina de pedidos/previsiones agrupada por PDF sin partir grupos, con totales, orden configurable y filtro triestado de estado en Ceox.';
