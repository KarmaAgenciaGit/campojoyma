-- Permite ordenar pedidos por fecha de negocio o por llegada al correo (created_at).
...
is 'Devuelve una página de pedidos/previsiones agrupada por PDF sin partir grupos, incluyendo fila meta con totales y orden configurable por fecha de negocio o llegada al correo.';
